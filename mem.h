...
extern const const char * __NEWMEM_FILE_NAME;
...
#define NEWMEM_SOURCE_TRACE(EXPRESSION)	{const const char *__f=__NEWMEM_FILE_NAME;int __l=__NEWMEM_FILE_LINE;if(!__NEWMEM_FILE_NAME){__NEWMEM_FILE_NAME=const_cast<const char *>(__FILE__);__NEWMEM_FILE_LINE=__LINE__;}	EXPRESSION;		if(!__NEWMEM_FILE_NAME){__NEWMEM_FILE_NAME=__f;__NEWMEM_FILE_LINE=__l;}}
